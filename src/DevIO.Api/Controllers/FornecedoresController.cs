...
namespace DevIO.Api.Controllers
{
    ...
    public class FornecedoresController : MainController
    {
        ...
        public FornecedoresController(IFornecedorRepository fornecedorRepository, IFornecedorService fornecedorService, IEnderecoRepository enderecoRepository, IMapper mapper, INotificador notificador)
            : base(notificador)
        {
